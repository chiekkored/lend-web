...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "For recurring bookings, Lend may split the amount into an upfront payment and future subscription billing through the payment provider. The upfront amount may include the first recurring cycle, smaller rental remainders, security deposit, applicable fees, and other non-subscription charges.",
      "A recurring booking may require subscription authorization after the upfront payment succeeds. The booking is not confirmed unless the required upfront payment and subscription authorization steps are completed and recorded by Lend.",
